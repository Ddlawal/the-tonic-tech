...
import { BatchResponse, getMessaging, Message, MulticastMessage } from 'firebase-admin/messaging'
...
export const sendBatchPushNotifications = async (messages: Message[]): Promise<BatchResponse | undefined> => {
    try {
